...
Six independent Codex review passes have produced 25 actionable correctness/security findings in total (8 P1 and 17 P2). Every finding now has a code fix or an already-landed equivalent fix and a targeted regression where applicable. The release gate still requires exact-head CI and a fresh review of the final immutable candidate rather than treating resolved historical findings as proof by themselves.

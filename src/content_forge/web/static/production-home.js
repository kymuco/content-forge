...
(() => {
  ...
  function renderProject(entry) {
    ...
    left.appendChild(text("p", `${String(project.content_kind || "project").replaceAll("_", " ")} · ${view.detail}`, "muted compact-text"));
  ...
  window.addEventListener("beforeunload", revokeArtifactUrls);
